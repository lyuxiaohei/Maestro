...
- **sub_steps**:
  ...
  2. 需求分类
  3. 优先级排序
- **domain_skill**: meeting-minutes（Phase 3 集成 ✅）
...
- **sub_steps**:
  ...
  2. 现状流程图绘制
  3. 痛点标注与优化建议
- **domain_skill**: diagram-design（Phase 2 集成 ✅）
...
- **sub_steps**:
  ...
  6. 待办事项汇总
  7. 纪要分发与确认
- **domain_skill**: meeting-minutes（Phase 3 集成 ✅，跨阶段复用）
...
- **sub_steps**:
  ...
  5. 竞品报告生成
  6. 截图采集指引（人工执行）
- **domain_skill**: competitive-analysis（Phase 2 集成 ✅）
...
- **sub_steps**:
  ...
  3. 覆盖度评估
  4. 优先级矩阵生成
- **domain_skill**: feature-list（Phase 4 集成 ✅）
...
- **sub_steps**:
  ...
  3. 原型页面生成
  4. 交互说明编写
- **domain_skill**: prototype-design（Phase 2 集成 ✅）
...
- **sub_steps**:
  ...
  4. 问题分级输出
  5. 改进建议生成
- **domain_skill**: prototype-review（Phase 4 集成 ✅）
...
- **sub_steps**:
  ...
  4. 页面设计稿生成
  5. 设计评审
- **domain_skill**: ui-design（Phase 5 集成 ✅）
...
- **sub_steps**:
  ...
  3. 方案概要设计
  4. 关键决策记录
- **domain_skill**: logic-list-spec Draft 模式（Phase 2 集成 ✅）
...
- **sub_steps**:
  ...
  6. 流程设计
  7. 评审基线整理
- **domain_skill**: architecture-design（Phase 6 集成 ✅）
...
- **sub_steps**:
  ...
  4. 安全性评审
  5. 评审报告生成
- **domain_skill**: architecture-review（Phase 6 集成 ✅）
...
- **sub_steps**:
  ...
  3. 变更影响评估
  4. 最终架构文档输出
- **domain_skill**: architecture-refinement（Phase 6 集成 ✅）
...
- **sub_steps**:
  ...
  6. 流程详细设计
  7. 测试策略制定
- **domain_skill**: detailed-design（Phase 6 集成 ✅）
...
- **sub_steps**:
  ...
  8. 汇总确认
  9. 里程碑定义
- **domain_skill**: dev-task-planner（Phase 7 集成 ✅）
...
- **sub_steps**:
  ...
  12. AI 审核（前后端）
  13. 联调自测
- **domain_skill**: frontend-dev + backend-dev + code-review（Phase 7 集成 ✅）
...
- **sub_steps**:
  ...
  8. 测试报告生成
  9. 测试归档
- **domain_skill**: test-engineering（Phase 8 集成 ✅）
...
- **sub_steps**:
  ...
  6. 验收报告生成
  7. 验收签核
- **domain_skill**: acceptance-testing（Phase 8 集成 ✅）
...
- **sub_steps**:
  ...
  3. 灰度发布
  4. 全量发布
- **domain_skill**: deployment（Phase 8 集成 ✅）
...
| 域 | 阶段范围 | 说明 |
|----|----------|------|
| product | P01-P04 | 需求调研、业务流程图、会议纪要、竞品分析 |
| design | P05-P08 | 功能清单、原型设计、原型复核、UI设计 |
| architecture | P09-P13 | 方案设计、架构设计、架构评审、架构细化、详细设计 |
| development | P14-P15 | 开发任务规划、前后端开发 |
| testing | P16-P17 | 系统测试、验收测试 |
| deployment | P18 | 部署上线 |
...
共 21 个 Skill，覆盖全部 18 个产研阶段。

| 需求编号 | Skill | 类型 | 开发阶段 | 覆盖阶段 |
|---------|-------|------|---------|----------|
| EXIST-01 | logic-list-spec | 已有复制 | Phase 2 ✅ | P06, P09 |
| EXIST-02 | prototype-design | 已有复制 | Phase 2 ✅ | P06 |
| EXIST-03 | prd-auto-generator | 已有复制 | Phase 2 ✅ | P09+ |
| EXIST-04 | diagram-design | 已有复制 | Phase 2 ✅ | P02 |
...
| 开发阶段 | Skill | 数量 |
|---------|-------|------|
| Phase 2（已有复制 + 新开发） | diagram-design, logic-list-spec, prototype-design, prd-auto-generator, competitive-analysis | 5 |
