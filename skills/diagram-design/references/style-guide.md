...
|---|---|---|---|
| `paper` | Page background, default node fill | `#f8fafc` (cool-white) | `#1a2a3a` (deep-navy) |
| `paper-2` | Diagram container bg, secondary fill | `#eef4fa` | `#2a3a4a` |
| `ink` | Primary text, primary stroke | `#1a2a3a` (deep-navy) | `#f0f4f8` (cool-white) |
| `muted` | Secondary text, default arrow stroke | `#3a6b8a` (steel-blue) | `#8faabe` (silver-blue) |
| `soft` | Sublabels, boundary labels | `#5a8aaa` | `#7a9ab8` |
| `rule` | Hairline borders | `rgba(26,42,58,0.10)` | `rgba(240,244,248,0.12)` |
| `rule-solid` | Stronger borders, baselines | `#a8c4de` (silver-blue) | `rgba(168,196,222,0.25)` |
| `accent` | Focal / 1–2 max per diagram | `#1a5276` (deep-blue) | `#3498db` |
| `accent-tint` | Fill for accent-bordered boxes | `rgba(26,82,118,0.08)` | `rgba(52,152,219,0.10)` |
| `link` | HTTP/API calls, external arrows | `#2c5f8a` | `#6aaed6` |
